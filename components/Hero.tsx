  ...
  return (
    <div className="hero">
      ...
      <h1 className="hero__title">
           Wellcome To <span className="text-green-900">Toko Informatika</span>
        </h1>
        ...
        <br></br>
        'Toko Informatika not only offers  <span className="text-green-900">innovative styles but also supports the economic growth of Bandung. </span>
        <br></br>
      ...
      <div className="hero__image-container">
        <div className="hero__image">
          <Image src="/fix.png" alt="hero" fill className="object-contain" />
        </div>
